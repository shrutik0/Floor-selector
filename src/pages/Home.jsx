...
const blocks = [
  {
    ...
    title: "D block",
    features: ["2bhk and 3bhk", "12 floors", "95 flats", "1350 - 1440 sq. ft."],
  },
  {
    ...
    <HomeStyle>
      ...
      <Collapsible>
        <HomePageDetailsStyle>
          <div className="tag-line">2, 3 and 3.5 BHK Premium Apartments</div>
          <div className="title">
            <Logo />
          </div>
          ...
          <div className="specs">
            ...
            <div className="items">
              ...
              <div className="item">
                <div className="key">444</div>
                <div className="value">Flats</div>
              </div>
              <div className="item">
                <div className="key">12</div>
